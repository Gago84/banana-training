...
const routineLevels = [
  {
    ...
    days: [
      ...
      day("fri", 5, "FRI", "Upper (pull day)", [
        ["WarmUp", "180s-0-1 set"],
        ["Pull up", "5 to 10-60s-3 sets"],
        ["Row (table)", "5 to 10-60s-3 sets"],
        ["Chin up", "5 to 10-60s-3 sets"],
        ["Cooldown", "180s-0s-1 set"],
      ]),
      restDay(),
  ...
  },
  {
    ...
    days: [
      ...
      day("wed", 3, "WED", "Lower", [
        ["WarmUp", "180s-0-1 set"],
        ["Right Bulgarian split", "20reps-10s-3sets"],
        ["Left Bulgarian split", "20reps-10s-3sets"],
        ["Right leg glute bridge", "20reps-10s-3sets"],
        ["Left leg glute bridge", "20reps-10s-3sets"],
        ["Right Single Calf raise", "20reps-10s-3sets"],
        ["Left Single Calf raise", "20reps-10s-3sets"],
        ["Cooldown", "180s-0s-1 set"],
      ]),
      day("thus", 4, "THUS", "Joints", [
        ["WarmUp", "180s-0-1 set"],
        ["Overhead rod", "60s-10s-3 sets"],
        ["Static Bridge", "60s-10s-3 sets"],
        ["DownDog", "60s-10s-3 sets"],
        ["Side Deep squat", "60s-10s-3 sets"],
      ...
      day("fri", 5, "FRI", "Upper (pull day)", [
        ["WarmUp", "180s-0-1 set"],
        ["One hand Pull up", "10-30s-3 sets"],
        ["One hand Row", "10-30s-3 sets"],
        ["One hand Chin up", "10-30s-3 sets"],
        ["Cooldown", "180s-0s-1 set"],
      ]),
      restDay(),
      day("sunday", 7, "SUNDAY", "Handstand training", [
        ["WarmUp", "180s-0-1 set"],
        ["Back to wall pushup", "5-10reps-60s-3 sets"],
        ["Face to wall pushup", "5-10reps-60s-3 sets"],
